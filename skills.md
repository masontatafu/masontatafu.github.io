...
<div class="about-section">
  <div class="skills-grid">
    ...
    <span class="skill-tag">AI-Assisted Automation</span>
    <span class="skill-tag">Playwright</span>
    <span class="skill-tag">JSON</span>
    <span class="skill-tag">Structured Data</span>
    <span class="skill-tag">Workflow Logic</span>
    <span class="skill-tag">Testing</span>
    <span class="skill-tag">Logging & Metrics</span>
  </div>
</div>
...
<div class="about-section">
  <div class="skills-grid">
    ...
    <span class="skill-tag">Enterprise Applications</span>
    <span class="skill-tag">Shopify</span>
    <span class="skill-tag">CMS Tools</span>
    <span class="skill-tag">Business Systems</span>
    <span class="skill-tag">Platform Support</span>
  </div>
</div>
...
<div class="about-section">
  <div class="skills-grid">
    ...
    <span class="skill-tag">Requirements</span>
    <span class="skill-tag">Use Cases</span>
    <span class="skill-tag">Changelogs</span>
    <span class="skill-tag">Metrics Reports</span>
